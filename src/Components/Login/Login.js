      ...
      <div className="w-[35rem] shadow-lg p-9 rounded animate-slide-up">
        ...
        <div>
          ...
          <div className="flex justify-between items-center space-x-4 py-4">
            <button className="rounded bg-slate-600 hover:bg-slate-700 transition-colors text-white border-none focus:outline-none w-full px-3 py-2 focus:ring-2 flex items-center justify-center gap-2">
